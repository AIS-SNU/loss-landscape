...
class WideResNet(nn.Module):
    ...
    def __init__(self, dataset, depth=28, num_classes=10, widen_factor=10, sub_block1=False, dropRate=0.0, bias_last=True):
    ...
    def forward(self, x):
        ...
        if 'cifar' in self.dataset:
            out = F.avg_pool2d(out, 8) ##~exp_id:430
        else:
            out = nn.AdaptiveAvgPool2d((1, 1))(out) #exp_id:431~
...
def WRN34_10(num_classes= 100):
    return WideResNet(depth=34, widen_factor=10, num_classes=num_classes, dataset='cifar100')
    #depth = 34
    #n = (depth - 2) // 6
    #return WResNet_cifar(BasicBlock, [n,n,n], 10)
