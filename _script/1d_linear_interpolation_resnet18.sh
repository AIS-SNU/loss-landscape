...
python plot_surface.py --cuda --x=-1:1:7 --model resnet56 --dir_type weights \
#--model_file checkpoints/baseline_trades_resnet18_ciar10.pt \
--model_file cifar10/trained_nets/resnet56_sgd_lr=0.1_bs=128_wd=0.0005 \
--xnorm filter --xignore biasbn --plot
